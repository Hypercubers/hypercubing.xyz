...
### Speedsolving rules for Hyperspeedcube 2

- Speedsolves of the following puzzles must have [video evidence](#video-evidence):
    - 3^4^ faster than 2m30s
    - 2^4^ faster than 30 seconds
    - 4^4^ faster than 10 minutes
    - 5^4^ faster than 20 minutes
- If there is no video evidence, then speedsolves must have a replay file that is timestamped and includes an online scramble. Ensure that "Online mode" is enabled in the settings and that the end screen says "This solve is timestamped."
...
- Inspection time over 60 seconds counts towards solve time. In other words: the timer starts on the first move or after 60 seconds of inspection, whichever happens first.

### Speedsolving rules for other software or physical puzzles

- All speedsolves must have [video evidence](#video-evidence).
